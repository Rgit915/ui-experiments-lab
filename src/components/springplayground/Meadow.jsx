...
import { GRASS_COLORS, HILL_COLORS, FLOWER_POSITIONS, FLOWER_TIMINGS } from "../../features/interactive/Constants";
import BloomFlower from "./BloomFlower";

export default function Meadow({ isDark }) {
  const { top: grassTop, back: hill1, mid: hill2 } = useMemo(() => ({
  ...
  return (
    <div className="relative w-full -mb-1" style={{ height: "200px" }}>
      ...
      >
        <path d="M0,200 L0,130 Q150,60 300,110 Q450,160 600,90 Q750,30 900,100 Q1050,160 1200,120 L1200,200 Z" fill={hill1}/>
        <path d="M0,200 L0,155 Q200,90 400,140 Q550,175 700,115 Q850,60 1000,130 Q1100,165 1200,145 L1200,200 Z" fill={hill2}/>
        {/* Front hill matches grassTop exactly — seamless blend with BunnyDemo */}
        <path d="M0,200 L0,172 Q100,138 250,163 Q400,184 550,152 Q700,122 850,158 Q1000,183 1200,168 L1200,200 Z" fill={grassTop}/>
      </svg>
